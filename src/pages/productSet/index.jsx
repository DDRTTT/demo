...
import { getTplList, auditTpls, getAllProductList, dictsInfo, getProductlList } from '@/services/productSet';
...
class Index extends Component {
  ...
  componentDidMount () {
    ...
    getProductlList({}).then(res=>{
      console.log(res);
      if (res.status === 200) {
        this.setState({ productType: res.data || [] });
      }
    })
    dictsInfo({ 
      path: null,
    ...
    return (
      <div>
        ...
        <div style={{ padding: '12px', background: '#ffffff' }}>
          <SeaHeader getList = {this.getList} productList={this.state.productList} productType={this.state.productType}/>
